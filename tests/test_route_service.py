...
from app.services.route_service import (
    parse_gpx, haversine_distance,
    upload_gpx_to_oss, download_gpx_from_oss, delete_gpx_from_oss,
)
...
@patch("app.services.route_service._get_bucket")
def test_upload_gpx_to_oss(mock_get_bucket):
...
@patch("app.services.route_service._get_bucket")
def test_download_gpx_from_oss(mock_get_bucket):
    mock_bucket = MagicMock()
    mock_get_bucket.return_value = mock_bucket
...
@patch("app.services.route_service._get_bucket")
def test_delete_gpx_from_oss(mock_get_bucket):
    mock_bucket = MagicMock()
    mock_get_bucket.return_value = mock_bucket
...
@patch("app.services.route_service._get_bucket")
def test_delete_gpx_from_oss_invalid_url(mock_get_bucket):
    """无效 URL 不抛异常"""
